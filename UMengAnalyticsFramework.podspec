#!/usr/bin/ruby
#  Be sure to run `pod spec lint UMengAnalyticsFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #
    ...
    # Or just: s.author    = "Arthur"
  # s.authors            = { "Arthur" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Arthur"
