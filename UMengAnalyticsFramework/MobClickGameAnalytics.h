...
+ (void)setUserLevel:(NSString *)level __deprecated_msg("use `setUserLevelId:` instead");

//已经被新的active user方法替代，请使用新的API。
+ (void)setUserID:(NSString *)userId sex:(int)sex age:(int)age platform:(NSString *)platform __deprecated_msg("use new api");
